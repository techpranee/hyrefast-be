...
const dbService = require('../utils/dbService');
  ...
  async function seedUser() {
    try{
      let userToBeInserted = {}
        userToBeInserted = {"password":"ZTGa9XJaI3O9UDA","isDeleted":false,"email":"Kathlyn.Wiza@hotmail.com","isActive":true,"userType":authConstant.USER_TYPES.Applicant}
        userToBeInserted.password = await  bcrypt.hash(userToBeInserted.password, 8)
        let applicant = await dbService.updateOne(User, {"email":"Kathlyn.Wiza@hotmail.com"}, userToBeInserted,  {
          upsert: true
        })
        userToBeInserted = {"password":"Dr2G4EdqflsITo2","isDeleted":false,"email":"Alicia.Connelly60@gmail.com","isActive":true,"userType":authConstant.USER_TYPES.Recruiter}
        userToBeInserted.password = await  bcrypt.hash(userToBeInserted.password, 8)
        let recruiter = await dbService.updateOne(User, {"email":"Alicia.Connelly60@gmail.com"}, userToBeInserted,  {
          upsert: true
        })
    ...
    async function seedRouteRole() {
      try{
        const routeRoles =[ 
          {
  route: '/client/api/v1/credit/create',
  role: 'System_User',
  method: 'POST'
},
          {
  route: '/client/api/v1/credit/addbulk',
  role: 'System_User',
  method: 'POST'
},
          {
  route: '/client/api/v1/credit/list',
  role: 'System_User',
  method: 'POST'
},
          {
  route: '/client/api/v1/credit/:id',
  role: 'System_User',
  method: 'GET'
},
          {
  route: '/client/api/v1/credit/count',
  role: 'System_User',
  method: 'POST'
},
          {
  route: '/client/api/v1/credit/update/:id',
  role: 'System_User',
  method: 'PUT'
},
          {
  route: '/client/api/v1/credit/partial-update/:id',
  role: 'System_User',
  method: 'PUT'
},
          {
  route: '/client/api/v1/credit/updatebulk',
  role: 'System_User',
  method: 'PUT'
},
          {
  route: '/client/api/v1/credit/softdelete/:id',
  role: 'System_User',
  method: 'PUT'
},
          {
  route: '/client/api/v1/credit/softdeletemany',
  role: 'System_User',
  method: 'PUT'
},
          {
  route: '/client/api/v1/credit/delete/:id',
  role: 'System_User',
  method: 'DELETE'
},
          {
  route: '/client/api/v1/credit/deletemany',
  role: 'System_User',
  method: 'POST'
},
          {
  route: '/client/api/v1/payment/create',
  role: 'System_User',
  method: 'POST'
},
          {
  route: '/client/api/v1/payment/addbulk',
  role: 'System_User',
  method: 'POST'
},
          {
  route: '/client/api/v1/payment/list',
  role: 'System_User',
  method: 'POST'
},
          {
  route: '/client/api/v1/payment/:id',
  role: 'System_User',
  method: 'GET'
},
          {
  route: '/client/api/v1/payment/count',
  role: 'System_User',
  method: 'POST'
},
          {
  route: '/client/api/v1/payment/update/:id',
  role: 'System_User',
  method: 'PUT'
},
          {
  route: '/client/api/v1/payment/partial-update/:id',
  role: 'System_User',
  method: 'PUT'
},
          {
  route: '/client/api/v1/payment/updatebulk',
  role: 'System_User',
  method: 'PUT'
},
          {
  route: '/client/api/v1/payment/softdelete/:id',
  role: 'System_User',
  method: 'PUT'
},
          {
  route: '/client/api/v1/payment/softdeletemany',
  role: 'System_User',
  method: 'PUT'
},
          {
  route: '/client/api/v1/payment/delete/:id',
  role: 'System_User',
  method: 'DELETE'
},
          {
  route: '/client/api/v1/payment/deletemany',
  role: 'System_User',
  method: 'POST'
},
          {
  ...
  method: 'POST'
          ...
          {
  route: '/client/api/v1/purchase/create',
  role: 'System_User',
  method: 'POST'
},
          {
  route: '/client/api/v1/purchase/addbulk',
  role: 'System_User',
  method: 'POST'
},
          {
  route: '/client/api/v1/purchase/list',
  role: 'System_User',
  method: 'POST'
},
          {
  route: '/client/api/v1/purchase/:id',
  role: 'System_User',
  method: 'GET'
},
          {
  route: '/client/api/v1/purchase/count',
  role: 'System_User',
  method: 'POST'
},
          {
  route: '/client/api/v1/purchase/update/:id',
  role: 'System_User',
  method: 'PUT'
},
          {
  route: '/client/api/v1/purchase/partial-update/:id',
  role: 'System_User',
  method: 'PUT'
},
          {
  route: '/client/api/v1/purchase/updatebulk',
  role: 'System_User',
  method: 'PUT'
},
          {
  route: '/client/api/v1/purchase/softdelete/:id',
  role: 'System_User',
  method: 'PUT'
},
          {
  route: '/client/api/v1/purchase/softdeletemany',
  role: 'System_User',
  method: 'PUT'
},
          {
  route: '/client/api/v1/purchase/delete/:id',
  role: 'System_User',
  method: 'DELETE'
},
          {
  route: '/client/api/v1/purchase/deletemany',
  role: 'System_User',
  method: 'POST'
},
          {
  route: '/client/api/v1/invitations/create',
  role: 'System_User',
  method: 'POST'
},
          {
  route: '/client/api/v1/invitations/addbulk',
  role: 'System_User',
  method: 'POST'
},
          {
  route: '/client/api/v1/invitations/list',
  role: 'System_User',
  method: 'POST'
},
          {
  route: '/client/api/v1/invitations/:id',
  role: 'System_User',
  method: 'GET'
},
          {
  route: '/client/api/v1/invitations/count',
  role: 'System_User',
  method: 'POST'
},
          {
  route: '/client/api/v1/invitations/update/:id',
  role: 'System_User',
  method: 'PUT'
},
          {
  route: '/client/api/v1/invitations/partial-update/:id',
  role: 'System_User',
  method: 'PUT'
},
          {
  route: '/client/api/v1/invitations/updatebulk',
  role: 'System_User',
  method: 'PUT'
},
          {
  route: '/client/api/v1/invitations/softdelete/:id',
  role: 'System_User',
  method: 'PUT'
},
          {
  route: '/client/api/v1/invitations/softdeletemany',
  role: 'System_User',
  method: 'PUT'
},
          {
  route: '/client/api/v1/invitations/delete/:id',
  role: 'System_User',
  method: 'DELETE'
},
          {
  route: '/client/api/v1/invitations/deletemany',
  role: 'System_User',
  method: 'POST'
},
          {
  route: '/client/api/v1/workspace/create',
  role: 'System_User',
  method: 'POST'
},
          {
  route: '/client/api/v1/workspace/addbulk',
  role: 'System_User',
  method: 'POST'
},
          {
  route: '/client/api/v1/workspace/list',
  role: 'System_User',
  method: 'POST'
},
          {
  route: '/client/api/v1/workspace/:id',
  role: 'System_User',
  method: 'GET'
},
          {
  route: '/client/api/v1/workspace/count',
  role: 'System_User',
  method: 'POST'
},
          {
  route: '/client/api/v1/workspace/update/:id',
  role: 'System_User',
  method: 'PUT'
},
          {
  route: '/client/api/v1/workspace/partial-update/:id',
  role: 'System_User',
  method: 'PUT'
},
          {
  route: '/client/api/v1/workspace/updatebulk',
  role: 'System_User',
  method: 'PUT'
},
          {
  route: '/client/api/v1/workspace/softdelete/:id',
  role: 'System_User',
  method: 'PUT'
},
          {
  route: '/client/api/v1/workspace/softdeletemany',
  role: 'System_User',
  method: 'PUT'
},
          {
  route: '/client/api/v1/workspace/delete/:id',
  role: 'System_User',
  method: 'DELETE'
},
          {
  route: '/client/api/v1/workspace/deletemany',
  role: 'System_User',
  method: 'POST'
},
          {
  ...
  method: 'POST'
          ...
          { route: '/client/api/v1/job/:id', role: 'System_User', method: 'GET' },
          {
  ...
  method: 'POST'
    ...
    async function seedUserRole (){
      try {
        const userRoles = [{"email":"Kathlyn.Wiza@hotmail.com","password":"ZTGa9XJaI3O9UDA"},{"email":"Alicia.Connelly60@gmail.com","password":"Dr2G4EdqflsITo2"}];
