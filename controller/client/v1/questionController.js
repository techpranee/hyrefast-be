...
const softDeleteQuestion = async(req,res) => {
    try{
        ...
        let updatedQuestion = await deleteDependentService.softDeleteQuestion(query, updateBody);
        if(!updatedQuestion){
            return res.recordNotFound();
        }
        return res.success({data:updatedQuestion});
...
const deleteQuestion =async(req,res) => {
    try{
        ...
        if (req.body.isWarning) { 
            deletedQuestion = await deleteDependentService.countQuestion(query);
        } else {
            deletedQuestion = await deleteDependentService.deleteQuestion(query);
        }
        if(!deletedQuestion){
            return res.recordNotFound();
        }
...
module.exports = {
    addQuestion,bulkInsertQuestion,findAllQuestion,getQuestion,getQuestionCount,updateQuestion,bulkUpdateQuestion,partialUpdateQuestion,softDeleteQuestion,deleteQuestion,deleteManyQuestion,softDeleteManyQuestion    
}