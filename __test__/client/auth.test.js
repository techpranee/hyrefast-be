...
beforeAll(async function (){
  try {
    ...
    insertedUser = await user.insertOne({
      username: 'Annie_DuBuque',
      password: '7_0TmgG7VjCCU8t',
      email: 'Kris.Schmitt20@gmail.com',
      name: 'Santiago Hudson',
      userType: 873,
      mobileNo: '(767) 320-7197',
      loginOTP: {},
      resetPasswordLink: {},
      loginRetryLimit: 134,
      loginReactiveTime: '2026-02-04T22:49:15.458Z',
      ssoAuth: { googleId: 'up' },
      id: '6898e052f56626ed02b5de42'
    });
  }
  catch (error) {
...
describe('POST /register -> if email and username is given', () => {
  test('should register a user', async () => {
    let registeredUser = await request(app)
      ...
      .send({
        'username':'Dallin.King',
        'password':'qH3A57dIO1dw2AT',
        'email':'Amalia.Funk68@gmail.com',
        'name':'Willard Herman',
        'userType':authConstant.USER_TYPES.Applicant,
        'mobileNo':'(849) 736-5578',
        'ssoAuth':{ 'googleId':'Orchestrator' },
...
describe('POST /forgot-password -> if email passed from request body is valid and OTP sent successfully', () => {
  test('should return success message', async () => {
    let user = await request(app)
      .post('/client/auth/forgot-password')
      .send({ 'email':'Amalia.Funk68@gmail.com', });
...
describe('POST /validate-otp -> OTP is sent in request body and OTP is correct', () => {
  test('should return success', () => {
    return request(app)
      ...
      .send(
        {
          username: 'Amalia.Funk68@gmail.com',
          password: 'qH3A57dIO1dw2AT'
        }).then(login => () => {
        return request(app)
